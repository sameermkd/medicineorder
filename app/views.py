...
def myorders(request):
    ...
    if request.method =="POST":
        ...
        print(name,email,item,quan,address,phone,image)
        ...
        myquery=MyOrders(name=name,email=email,items=item,address=address,quantity=quan,price=newPrice,phone_num=phone,image=image)
        myquery.save()
